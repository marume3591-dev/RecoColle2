...
/**
 ...
 @return BOOL スポットが登録済みの場合はYES
 */
+ (BOOL)getNativeAdData:(NSString *)spotId Delegate:(id<IMobileSdkAdsDelegate>)deleage __deprecated;
 ...
 */
+ (BOOL)getNativeAdData:(NSString *)spotId Params:(ImobileSdkAdsNativeParams *)params Delegate:(id<IMobileSdkAdsDelegate>)deleage __deprecated;
